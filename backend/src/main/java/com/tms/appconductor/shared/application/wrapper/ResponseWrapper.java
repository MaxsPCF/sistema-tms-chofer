...
public record ResponseWrapper<T>(
        ...
        @Schema(description = "Datos de la respuesta") T data,

        @Schema(description = "Mensaje descriptivo de la operación", example = "Operación exitosa") String message,

        @Schema(description = "Lista de errores si la operación falló") List<String> errors,

        @Schema(description = "Timestamp de la respuesta") @JsonFormat(pattern = "yyyy-MM-dd'T'HH:mm:ss.SSS'Z'") LocalDateTime timestamp,

        @Schema(description = "ID de trazabilidad de la petición") String traceId) {
