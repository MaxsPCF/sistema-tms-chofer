...
public class ErrorAttributes {
        ...
        public static ErrorAttributes forValidation(
                ...
                return ErrorAttributes.builder()
                                .type("https://api.tms-transporte.com/errors/validation-error")
        ...
        public static ErrorAttributes forNotFound(
                ...
                return ErrorAttributes.builder()
                                .type("https://api.tms-transporte.com/errors/not-found")
        ...
        public static ErrorAttributes forAuthentication(
                        ...
                        String traceId) {
                return ErrorAttributes.builder()
                                .type("https://api.tms-transporte.com/errors/authentication-error")
        ...
        public static ErrorAttributes forAccessDenied(
                        ...
                        String traceId) {
                return ErrorAttributes.builder()
                                .type("https://api.tms-transporte.com/errors/forbidden")
        ...
        public static ErrorAttributes forBusinessError(
                        ...
                        String traceId) {
                return ErrorAttributes.builder()
                                .type("https://api.tms-transporte.com/errors/business-error")
        ...
        public static ErrorAttributes forLocked(
                        ...
                        String traceId) {
                return ErrorAttributes.builder()
                                .type("https://api.tms-transporte.com/errors/account-locked")
        ...
        public static ErrorAttributes forRateLimit(
                        ...
                        String traceId) {
                return ErrorAttributes.builder()
                                .type("https://api.tms-transporte.com/errors/rate-limit-exceeded")
        ...
        public static ErrorAttributes forInternalError(
                        ...
                        String traceId) {
                return ErrorAttributes.builder()
                                .type("https://api.tms-transporte.com/errors/internal-error")
        ...
        public static ErrorAttributes forServiceUnavailable(
                        ...
                        String traceId) {
                return ErrorAttributes.builder()
                                .type("https://api.tms-transporte.com/errors/service-unavailable")
