...
import com.genesis.flota.shared.domain.exception.BaseDomainException;
...
public class ProblemDetailBuilder {
    ...
    public ProblemDetailBuilder forValidationError() {
        return this
                .withType("https://api.genesis.com/errors/validation-error")
    ...
    public ProblemDetailBuilder forNotFound(String entityName, Object entityId) {
        return this
                .withType("https://api.genesis.com/errors/not-found")
    ...
    public ProblemDetailBuilder forAuthenticationError() {
        return this
                .withType("https://api.genesis.com/errors/authentication-error")
    ...
    public ProblemDetailBuilder forAccessDenied() {
        return this
                .withType("https://api.genesis.com/errors/forbidden")
    ...
    public ProblemDetailBuilder forAccountLocked() {
        return this
                .withType("https://api.genesis.com/errors/account-locked")
    ...
    public ProblemDetailBuilder forBusinessError() {
        return this
                .withType("https://api.genesis.com/errors/business-error")
    ...
    public ProblemDetailBuilder forRateLimit() {
        return this
                .withType("https://api.genesis.com/errors/rate-limit-exceeded")
    ...
    public ProblemDetailBuilder forInternalError() {
        return this
                .withType("https://api.genesis.com/errors/internal-error")
    ...
    public ProblemDetailBuilder forServiceUnavailable() {
        return this
                .withType("https://api.genesis.com/errors/service-unavailable")
    ...
    public ErrorAttributes build() {
        return ErrorAttributes.builder()
                ...
                .timestamp(timestamp != null ?
                        java.time.LocalDateTime.ofInstant(timestamp, java.time.ZoneId.of("UTC")) : null)
                .errorCode(errorCode)
                .traceId(traceId)
