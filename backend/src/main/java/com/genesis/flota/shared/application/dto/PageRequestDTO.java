...
public record PageRequestDTO(
        ...
        @Schema(description = "Número de página (0-based)", example = "0", defaultValue = "0")
        ...
        @Schema(description = "Campo para ordenar", example = "fechaCreacion")
        String sort,

        @Schema(description = "Dirección del ordenamiento (ASC/DESC)", example = "DESC")
        String direction
) {
    public PageRequestDTO {
        ...
        if (sort == null || sort.isBlank()) sort = "fechaCreacion";
