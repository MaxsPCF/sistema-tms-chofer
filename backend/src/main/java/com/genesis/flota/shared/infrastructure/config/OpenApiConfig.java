...
public class OpenApiConfig {
    ...
    @Bean
    public OpenAPI genesisFlotaOpenAPI() {
        return new OpenAPI()
                .info(new Info()
                        .title("Genesis Flota API")
                        .description("""
                    ...
                    """)
                        .version("1.0.0")
                        .contact(new Contact()
                                .name("Genesis Dev Team")
                                .email("dev@genesis.com")
                                .url("https://genesis.com"))
                        .license(new License()
                                .name("Propietario - Todos los derechos reservados")
                                .url("https://genesis.com/license")))
                .servers(List.of(
                        new Server()
                                .url("http://localhost:" + serverPort)
                                .description("Desarrollo Local"),
                        new Server()
                                .url("https://dev-api.genesis.com")
                                .description("Desarrollo"),
                        new Server()
                                .url("https://staging-api.genesis.com")
                                .description("Staging"),
                        new Server()
                                .url("https://api.genesis.com")
